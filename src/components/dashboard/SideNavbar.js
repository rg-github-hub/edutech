export default function SideNavbar(){
    return <div class="col-md-3 col-lg-2 sidebar-offcanvas pl-0" id="sidebar" role="navigation" style={{backgroundColor:"#e9ecef"}}>
    <ul class="nav flex-column sticky-top pl-0 pt-5 p-3 mt-3 ">
        <li class="nav-item mb-2 mt-3"><a class="nav-link text-secondary" href="#"><h5>Jacob Nejam</h5></a></li>
        <li class="nav-item mb-2 "><a href="/" class="nav-link text-secondary" ><i class="fas fa-user font-weight-bold"></i> <span className="ml-3">Create New User</span></a></li>
